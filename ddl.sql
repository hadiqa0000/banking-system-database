...
CREATE TABLE Individual (
    ...
    individual_SSN VARCHAR(9) NULL,
    individual_nationality VARCHAR(65) NOT NULL,
    individual_registration_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, 
    individual_occupation VARCHAR(100) NULL, 
    individual_marital_status VARCHAR(15) NOT NULL CHECK (marital_status IN ('married', 'single', 'divorced', 'widowed', 'separated')),
    individual_disability BOOLEAN NOT NULL DEFAULT FALSE,
    individual_disability_type VARCHAR(100) NULL,
    individual_disability_desc VARCHAR(150) NULL,
    individual_annual_income DECIMAL(15, 2) NOT NULL CHECK (annual_income >= 0), 
    individual_employment_status VARCHAR(100) NOT NULL CHECK (employment_status IN ('employed', 'unemployed', 'self_employed', 'retired')),
    individual_country_of_residence CHAR(2) NOT NULL, 
    individual_city_of_residence VARCHAR(100) NOT NULL,
    individual_district_of_residence VARCHAR(100) NOT NULL,
    individual_customer_status VARCHAR(15) NOT NULL CHECK (customer_status IN ('active', 'inactive', 'blacklisted')),
    individual_deceased_flag BOOLEAN NOT NULL DEFAULT FALSE,
    PRIMARY KEY (bank_id, party_id),
...
CREATE TABLE Account (
    ...
    account_current_balance DECIMAL(18,2) NOT NULL DEFAULT 0.00,
    account_available_balance DECIMAL(18,2) NOT NULL DEFAULT 0.00,
    account_status VARCHAR(20) NOT NULL,
    account_type VARCHAR(30) NOT NULL,
    account_opened_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    account_closed_at TIMESTAMP NULL,
    account_last_activity_at TIMESTAMP NULL,
    account_overdraft_limit DECIMAL(18, 2) DEFAULT 0 CHECK (overdraft_limit >= 0),
    account_interest_rate DECIMAL(5, 2) NULL CHECK (interest_rate >= 0),
    account_minimum_balance DECIMAL(18, 2) NULL DEFAULT 0 CHECK (minimum_balance >= 0),
...
CREATE TABLE Account_ownership (
    ...
    account_ownership_pct DECIMAL(5, 2) NOT NULL DEFAULT 100.00 CHECK (ownership_pct BETWEEN 0 AND 100),
    account_ownership_start_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    account_ownership_end_date TIMESTAMP NULL,
    account_ownership_status VARCHAR(15) CHECK (ownership_status IN ('active', 'inactive', 'revoked')),
    account_ownership_created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE JournalEntry (
    ...
    journalentry_timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    journalentry_reference_type VARCHAR(20) NOT NULL,
    journalentry_reference_id BIGINT NOT NULL,
    journalentry_description VARCHAR(255) NOT NULL,
    journalentry_posting_status VARCHAR(15) NOT NULL CHECK (posting_status IN ('draft', 'posted', 'reversed')),
    journalentry_posted_at TIMESTAMP NULL,
    journalentry_posted_by_employee_id BIGINT NULL,
    journalentry_source_system VARCHAR(30) NOT NULL,
    reversal_of_journal_id BIGINT NULL,
    journalentry_batch_id BIGINT NULL,
    journalentry_currency_code CHAR(3) NOT NULL,
